...
Takes data from `modelCombLesions.Rmd` and optimises
...
This result, newdf, is predictions from the model to then plot against people. So it has to be in a slightly different format: make it wide
...
This now is implicitly the 'include' ones, and it is the fitted model, so we can just merge back in the participant numbers and then send for plotting.
